...
def send_message_to_discord():
    ...
    if discord_webhook_response.ok:
        print(f"posting message to discord, response is {discord_webhook_response}")
    else:
        print(f"attempted to post message to discord, response is {discord_webhook_response}")
